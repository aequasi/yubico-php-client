<?php
/**
 * YubiCloud -- verify YubiKey One-Time Passwords (OTPs) against YubiCloud
 *
 * PHP Version 5
 *
 * @category    Auth
 ...
 * @version     2.0
 * @link        https://developers.yubico.com/yubico-php-client/
...
class YubiCloud
{
   ...
   * @internal
   */
  protected $urls = array('api.yubico.com/wsapi/2.0/verify',
